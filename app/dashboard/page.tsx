...
import {
  ...
  Sparkles, CpuIcon, MoveRight, Star, AlertTriangle, LineChart, FolderKanban, Users
} from "lucide-react"
...
export default function DashboardPage() {
  ...
  // Quick access links
  const quickLinks = [
    { name: "Insights", href: "/dashboard/insights", icon: <LineChart className="h-4 w-4" />, description: "Business analytics" },
    { name: "Models", href: "/dashboard/models", icon: <BrainCircuit className="h-4 w-4" />, description: "AI models" },
    { name: "Projects", href: "/dashboard/projects", icon: <FolderKanban className="h-4 w-4" />, description: "Active projects" },
    { name: "Team", href: "/dashboard/team", icon: <Users className="h-4 w-4" />, description: "Team members" },
  ]

  return (
    <div className="space-y-6 pb-8 px-1 sm:px-2 md:px-4">
      {/* Welcome Section */}
      <div className="grid gap-4 grid-cols-1 lg:grid-cols-4">
        ...
        >
          <Card className="shadow-lg border-0 overflow-hidden relative bg-gradient-to-br from-background/90 to-background/60 backdrop-blur-md">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
                {quickLinks.map((link, index) => (
                  ...
                  >
                    <Link 
                      href={link.href} 
                      className="block p-4 rounded-lg bg-white/5 hover:bg-white/10 shadow-md hover:shadow-lg transition-all h-full border border-white/5"
                    >
                      ...
                      <div className="text-xs flex items-center text-red-500 mt-auto">
                        <span>View</span>
        ...
        >
          <Card className="shadow-lg border-0 overflow-hidden h-full relative bg-gradient-to-br from-background/90 to-background/60 backdrop-blur-md">
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-red-800 via-red-600 to-red-800"></div>
            <CardHeader className="pb-2">
            ...
            <CardContent className="pb-6">
              <div className="flex items-center justify-center p-2 rounded-md mb-4 bg-gradient-to-r from-green-500/10 to-green-500/5 border border-green-500/10">
                <CheckCircle2 className="h-5 w-5 mr-2 text-green-500" />
                <span className="font-medium">All Systems Operational</span>
              </div>
              <div className="text-xs text-muted-foreground">
                <div className="flex justify-between py-2 border-t border-border/10">
      ...
      <div className="grid gap-4 grid-cols-1 lg:grid-cols-3">
        ...
        >
          <Card className="bg-gradient-to-br from-background/90 to-background/60 backdrop-blur-md shadow-lg border-0 relative overflow-hidden">
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-red-800 via-red-600 to-red-800"></div>
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              ...
              <Badge variant="outline" className="text-xs shadow-md bg-red-500/10 text-red-500 border-red-500/20">
        ...
        <motion.div 
          ...
          className="col-span-1"
        >
          <Card className="bg-gradient-to-br from-background/90 to-background/60 backdrop-blur-md shadow-lg border-0 relative h-full overflow-hidden">
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-red-800 via-red-600 to-red-800"></div>
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-base flex items-center gap-2">
                <div className="p-1.5 rounded-full bg-red-500/10">
            ...
            <CardContent className="pb-6">
              {alertsLoading ? (
                ...
                <div className="flex flex-col items-center justify-center h-[250px] md:h-[300px] text-center">
        ...
        >
          <Card className="bg-gradient-to-br from-background/90 to-background/60 backdrop-blur-md shadow-lg border-0 relative overflow-hidden">
            ...
            <CardHeader className="pb-2">
              <CardTitle className="text-base flex items-center gap-2">
                <div className="p-1.5 rounded-full bg-red-500/10">
                  <CpuIcon className="h-4 w-4 text-red-500" />
                </div>
                System Health
              </CardTitle>
            </CardHeader>
        ...
        >
          <Card className="bg-gradient-to-br from-background/90 to-background/60 backdrop-blur-md shadow-lg border-0 relative overflow-hidden">
            ...
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              ...
              <Button variant="outline" size="sm" asChild className="shadow-md bg-background/80 hover:bg-red-500/10 hover:text-red-400 border-red-500/20">
                <Link href="/dashboard/insights" className="flex items-center gap-1">
                  View All
            ...
            <CardContent className="pb-6">
              <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2">
                <motion.div 
                  className="bg-white/5 p-4 rounded-lg shadow-md hover:shadow-lg transition-all border border-white/5"
                  whileHover={{ y: -2, transition: { duration: 0.2 } }}
                >
                  ...
                  <p className="text-sm text-muted-foreground mb-3">Cross-selling opportunities could increase revenue by 15%</p>
                  <div className="flex justify-between items-center text-xs">
                    <Badge className="bg-red-500/10 text-red-500 shadow-md border-red-500/20">high impact</Badge>
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground mb-3">Unusual drop in API usage may indicate churn risk</p>
                  <div className="flex justify-between items-center text-xs">
                    <Badge className="bg-red-500/10 text-red-500 shadow-md border-red-500/20">medium impact</Badge>
                    <span className="text-muted-foreground">79% confidence</span>
                  </div>
                </motion.div>
              </div>
            </CardContent>
