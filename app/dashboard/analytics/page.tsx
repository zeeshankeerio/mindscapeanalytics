  ...
  return (
    <div className="w-full space-y-4 pb-8 px-2 sm:px-4">
      ...
      <Tabs defaultValue="overview" className="space-y-4" onValueChange={setActiveTab}>
        <TabsList className="w-full overflow-x-auto flex-nowrap overflow-scrolling-touch pb-1">
          ...
          <div className="grid gap-3 sm:gap-4 grid-cols-2 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <Card className="overflow-hidden">
              ...
              <CardContent className="pt-2 sm:pt-4">
                ...
                <div className="h-1 w-full bg-muted mt-2 sm:mt-3 rounded-full overflow-hidden">
                  <div 
                    className="h-full bg-gradient-to-r from-green-500 to-red-500 transition-all duration-500" 
                    style={{ width: `${Math.min(+averageLatency / 2, 100)}%` }}
                  />
            </div>
          </CardContent>
        </Card>
            ...
            <Card className="overflow-hidden">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 bg-muted/10">
                ...
                <div className="rounded-full bg-green-500/10 p-1">
                  <BarChart className="h-3 w-3 sm:h-4 sm:w-4 text-green-500" />
                </div>
          </CardHeader>
              <CardContent className="pt-2 sm:pt-4">
                ...
                <div className="w-full h-6 sm:h-8 mt-2">
                  {/* Chart will be rendered here if available */}
                  {typeof ApiUsageChart !== 'undefined' && (
                    <ApiUsageChart height={32} compact={true} refreshTrigger={refreshTrigger} />
                  )}
            </div>
          </CardContent>
        </Card>
            ...
            <Card className="overflow-hidden">
              ...
              <CardContent className="pt-2 sm:pt-4">
                ...
                <Progress className="h-1 mt-2 sm:mt-3" value={+errorRate * 10} />
              </CardContent>
            </Card>
            </div>
