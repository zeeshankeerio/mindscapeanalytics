    ...
    <>
      ...
      <main className="relative min-h-screen bg-gradient-to-b from-black via-black/95 to-black text-white overflow-x-hidden">
        ...
        >
          ...
          <div className={getContainerClasses({ fullWidth: false, className: "relative z-10" })}>
            <motion.div 
              variants={fadeIn}
              initial="hidden"
              animate={heroInView ? "visible" : "hidden"}
            ...
            >
              ...
              <h1 id="hero-heading" className="text-5xl md:text-7xl font-bold tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-white to-white/80">
          ...
          <div className={getContainerClasses({ fullWidth: false, className: "relative z-10" })}>
            ...
            >
              {[
                ...
                >
                  <Card
                    className="bg-gradient-to-br from-black/60 to-black/40 backdrop-blur-md border border-white/10 overflow-hidden group hover:border-red-500/50 transition-colors duration-300 hover:shadow-[0_0_25px_rgba(220,38,38,0.1)] card-hover h-full"
                >
        ...
        >
          ...
          <div className={getContainerClasses({ fullWidth: true, className: "relative z-10" })}>
            ...
            <div className="relative px-0 md:px-4 lg:px-8 max-w-[1600px] mx-auto carousel-container">
        ...
        >
          ...
          <div className={getContainerClasses({ fullWidth: true, className: "relative z-10" })}>
            <motion.div 
              className="max-w-6xl mx-auto bg-gradient-to-br from-black/60 to-black/40 backdrop-blur-md border border-white/10 rounded-2xl p-8 md:p-12 shadow-[0_0_50px_rgba(255,0,0,0.2)] hover:shadow-[0_0_60px_rgba(255,0,0,0.25)] transition-all duration-300 card-hover"
              whileHover={{ y: -5 }}
            >
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  <h2 className="text-2xl md:text-4xl font-bold mb-4">Ready to Transform Your Business with AI?</h2>
                  <p className="text-white/70 mb-6 text-lg">
                    Discover how our AI solutions can drive innovation, optimize operations, and create new
                    opportunities for your organization.
                  </p>
                  <div className="flex flex-col sm:flex-row gap-4">
                    <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                      <Button size="lg" className="bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white shadow-lg shadow-red-900/20 w-full sm:w-auto">
                        Schedule a Demo
                        <ArrowRight className="ml-2 h-5 w-5" />
                    </Button>
                    </motion.div>
                    <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                      <Button size="lg" variant="outline" className="border-white/10 hover:bg-white/5 text-white backdrop-blur-sm w-full sm:w-auto">
                        Contact Us
                    </Button>
                    </motion.div>
                  </div>
                ...
                <div className="relative">
                  <div className="absolute -inset-4 bg-red-500/10 rounded-full blur-3xl opacity-30"></div>
                      <Image
                    src="https://images.unsplash.com/photo-1580894732444-8ecded7900cd?q=80&w=2070&auto=format&fit=crop"
                    alt="AI Technology" 
                    width={600} 
                    height={400}
                    className="rounded-xl border border-white/10 shadow-lg hover:shadow-red-900/20 transition-all duration-300 image-hover"
                  />
                </div>
              </div>
            </motion.div>
...
const teamMembers = [
  ...
  },
  {
    ...
    achievements: [
      ...
      "Implemented efficient backend systems"
    ],
    education: [
