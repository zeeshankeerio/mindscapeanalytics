...
import { ArrowRight, Brain, Code, Database, LineChart, Users, Zap, Linkedin, Twitter, Github, Mail, ShieldIcon, TargetIcon } from "lucide-react"
      ...
      >
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          >
            ...
            <div className="relative">
              <div className="absolute -inset-4 bg-red-500/20 rounded-full blur-3xl opacity-30 animate-pulse-slow"></div>
              <img
            ...
            {[
              ...
              },
              {
                ...
                description:
                  ...
                  icon: <ShieldIcon className="h-10 w-10 text-red-500" />,
              },
              {
                title: "Impact",
                description:
                  ...
                  icon: <TargetIcon className="h-10 w-10 text-red-500" />,
              },
            ].map((value, index) => (
              <Card
                key={index}
          ...
          <Tabs defaultValue="leadership" className="w-full">
            ...
            >
              <TabsList className="bg-black/50 border border-white/10 p-1">
                <TabsTrigger
                  value="leadership"
                  className="data-[state=active]:bg-red-500 data-[state=active]:text-white transition-all duration-300"
                >
                  Leadership
                </TabsTrigger>
                <TabsTrigger 
            ...
            <TabsContent value="leadership" className="mt-0">
              <motion.div 
                ...
                className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 team-grid"
              >
                {teamMembers
            ...
            <TabsContent value="research" className="mt-0">
              ...
              >
                {teamMembers
                  .filter((member) => member.department === "Research")
                  .map((member, index) => (
                    <TeamMemberCard key={index} member={member} />
                  ))}
              </motion.div>
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-4xl mx-auto bg-black/60 backdrop-blur-md border border-white/10 rounded-2xl p-8 md:p-12 shadow-[0_0_50px_rgba(255,0,0,0.2)] card-hover">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold mb-4 gradient-text">Join Our Team</h2>
                <p className="text-white/70 mb-6">
              ...
              <div className="relative">
                <div className="absolute -inset-4 bg-red-500/20 rounded-full blur-3xl opacity-50 animate-pulse-slow"></div>
                <img
...
const teamMembers = [
  ...
  },
  {
    ...
    role: "CTO & Co-Founder",
    bio: "Former VP of Engineering at Amazon Web Services, specializing in distributed systems and cloud architecture.",
  ...
  },
  {
    ...
    bio: "Product leader with experience at Netflix and Spotify. Expert in building AI-powered products that users love.",
  ...
  },
  {
    ...
    bio: "Specializes in natural language processing and large language models. Previously worked on GPT models at OpenAI.",
  ...
  },
  {
    ...
    bio: "Expert in reinforcement learning and robotics. Ph.D. from MIT with 15+ years of research experience.",
  ...
  },
  {
    ...
    bio: "Pioneering work in object detection and image segmentation. Previously at NVIDIA Research.",
  ...
  },
  {
    ...
    bio: "Scaling engineering teams and systems at high-growth companies for over 15 years.",
  ...
  },
  {
    ...
    bio: "Expert in deploying ML models at scale. Previously led ML infrastructure at Spotify.",
  ...
  },
  {
    ...
    bio: "Distributed systems expert with experience building high-performance, scalable backends.",
  ...
  },
  {
    ...
    bio: "Product visionary who previously led product teams at Microsoft and Salesforce.",
