...
import { MessageSquare, Phone, ArrowRight, Calendar, Linkedin, Globe } from "lucide-react"
...
export default function ContactPage() {
  ...
  const { ref: additionalRef, inView: additionalInView } = useInView({ triggerOnce: true })
  const { ref: qrRef, inView: qrInView } = useInView({ triggerOnce: true })
