          ...
          <div className="mt-12 flex items-center justify-center gap-8">
            <div className="flex items-center">
              <Badge className="bg-black/30 text-white/70 border-white/10 flex gap-2 items-center">
                <Image src="/images/partners/aws.svg" alt="AWS" width={500} height={300} className="h-4 w-4" />
                <span>AWS Partner</span>
              </Badge>
            </div>
            <div className="flex items-center">
              <Badge className="bg-black/30 text-white/70 border-white/10 flex gap-2 items-center">
                <Image src="/images/partners/azure.svg" alt="Azure" width={500} height={300} className="h-4 w-4" />
                <span>Azure Certified</span>
              </Badge>
            </div>
            <div className="flex items-center">
              <Badge className="bg-black/30 text-white/70 border-white/10 flex gap-2 items-center">
                <Image src="/images/partners/google-cloud.svg" alt="GCP" width={500} height={300} className="h-4 w-4" />
                <span>GCP Ready</span>
              </Badge>
            </div>
          </div>
