...
const AdvancedFeatureCard = ({ feature, delay }: { feature: AdvancedAnalyticsFeature; delay: number }) => (
  ...
  >
    <div className="flex flex-col sm:flex-row items-start gap-4">
      <div className="p-3 bg-red-500/10 rounded-lg mb-3 sm:mb-0">
        {feature.icon}
      </div>
    ...
    <section className="py-24 bg-black text-white relative overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-5xl mx-auto mb-24">
          ...
          >
            <div className="bg-black px-6 py-2 rounded-full border border-white/10">
