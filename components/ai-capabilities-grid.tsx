          ...
          >
            <div
              className={`
                ...
                bg-gradient-to-br ${getHoverGradient(capability.id)}
              `}
            />
            <Card
              className={`
              ...
              <CardHeader className="space-y-2 pb-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    <div className={`
                      p-2 rounded-xl bg-gradient-to-br ${getBorderGradient(capability.id)}
                    ...
                    <div>
                      <CardTitle className="text-lg font-semibold leading-none">
                        {capability.shortTitle || capability.title}
                      </CardTitle>
                ...
                <CardDescription className="text-sm text-white/80 line-clamp-2">
                  {capability.description}
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <div className="flex items-center space-x-1">
                      {capability.features.slice(2).map((_, i) => (
                        <div
                          key={i}
      ...
      <AnimatePresence mode="wait">
        {selectedCapability && (
          ...
          >
            ...
            />
            <Card className="relative w-full max-w-4xl max-h-[90vh] overflow-hidden bg-black/90 border-white/10">
              <ScrollArea className="h-full">
                <div className="p-6">
                  <CapabilityDetail
                    ...
                    onModelSettingsChange={(setting, value) => setModelSettings(prev => ({
                      ...prev,
                      [setting]: value
                    }))}
                  />
