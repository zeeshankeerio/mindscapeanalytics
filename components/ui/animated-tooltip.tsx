        ...
        >
          {hoveredIndex === item.id && (
            <motion.div
              ...
              className="bg-muted absolute -left-1/2 -top-16 z-50 flex translate-x-1/2 flex-col items-center justify-center rounded-md px-4 py-2 text-xs shadow-xl"
            >
              ...
              <div className="text-primary relative z-30 text-base font-bold">
                {item.name}
              </div>
