...
function EnhancedIndustryCard({
  ...
  return (
    ...
    >
      <div
        className={`w-full h-full py-3 px-3 rounded-lg transition-all duration-200 flex flex-col items-center justify-center gap-2 relative overflow-hidden border shadow-lg ${isActive
      ...
      >
        ...
        {compareMode && (
          ...
          >
            <div className={`h-5 w-5 rounded-full flex items-center justify-center ${isCompared
                      ...
                      {activeIndustry.solutions.slice(0, 5).map((solution, idx) => (
                        <li key={idx} className="flex items-center justify-between">
                          ...
                          {solutionBadges[solution]?.type && (
                            <Badge className={`text-[10px] ${solutionBadges[solution].type === 'new'
