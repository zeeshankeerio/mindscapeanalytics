...
export function NewsletterSubscription() {
  ...
  return (
    <div className="relative overflow-hidden rounded-xl border border-white/10 bg-black/80 backdrop-blur-md p-8 shadow-xl shadow-black/5">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  className="bg-black/50 border-white/10 text-white placeholder:text-white/40 focus-visible:ring-red-500 focus-visible:ring-offset-0"
              ...
              <Button 
                type="submit" 
                className="w-full bg-red-600 hover:bg-red-700 text-white relative z-50" 
                disabled={isSubmitting}
              >
                {isSubmitting ? (
                  <>
