...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-black border-t border-white/10 text-white overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6 py-12 sm:py-16">
        {/* Newsletter Subscription Section */}
        <div className="mb-12 sm:mb-16 rounded-2xl p-4 sm:p-8 backdrop-blur-sm bg-gradient-to-r from-black/80 to-black/40 border border-white/10">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="max-w-md">
              <h2 className="text-xl sm:text-2xl font-bold mb-2">Stay updated with Mindscape</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto relative">
              ...
              <Button 
                className="bg-red-600 hover:bg-red-700 text-white group transition-all duration-300 overflow-hidden relative mt-2 sm:mt-0"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 mb-12">
          ...
          <div className="lg:col-span-4">
                ...
                <div className="flex items-center gap-4 group">
                  ...
                  <div className="relative">
                    ...
                    <div className="relative z-10 group">
                      ...
                      {/* Icon container */}
                      <div className="relative bg-black rounded-2xl p-2 sm:p-3 transition-all duration-300 group-hover:scale-[0.98]">
                        <Image 
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:admin@mindscapeanalytics.com" className="text-sm sm:text-base text-white/70 hover:text-white transition-colors">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+11234567890" className="text-sm sm:text-base text-white/70 hover:text-white transition-colors">
                  +1 (123) 456-7890
                </a>
              </div>
            </div>
            ...
            <div className="flex gap-3 sm:gap-4">
              <a
                ...
                className="w-9 h-9 sm:w-10 sm:h-10 rounded-full flex items-center justify-center bg-white/5 border border-white/10 text-white/70 hover:text-white hover:bg-red-500/20 hover:border-red-500/30 transition-all duration-300"
                aria-label="Twitter"
          ...
          {footerNav.main.map((section, i) => (
            <div key={i} className="mb-6 md:mb-0">
                  <h3 className="font-medium text-base sm:text-lg mb-3 sm:mb-4 pb-2 border-b border-white/10">{section.title}</h3>
              <ul className="space-y-2 sm:space-y-3">
                {section.items.map((item, j) => (
                  <li key={j}>
                        <Link 
                          href={item.href} 
                          className="text-sm sm:text-base text-white/70 hover:text-white transition-colors flex items-center group"
                        >
