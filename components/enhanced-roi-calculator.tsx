  ...
  return (
    <div className="p-2 sm:p-4">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid grid-cols-3 mb-4 overflow-x-auto max-w-full flex-nowrap min-w-full">
          <TabsTrigger value="inputs" className="text-xs sm:text-sm">Inputs</TabsTrigger>
          <TabsTrigger value="templates" className="text-xs sm:text-sm">Industry Templates</TabsTrigger>
          <TabsTrigger value="results" disabled={!results} className="text-xs sm:text-sm">
              ...
              {comparisonMode && (
                <div className="mt-2 p-2 rounded bg-red-500/10 border border-red-500/20">
                  ...
                  <div className="mt-2 flex flex-col sm:flex-row gap-2 items-center">
                    <input
                      className="flex-1 text-sm bg-black/50 border border-white/10 rounded p-1 w-full"
          ...
          <Card className="bg-black/30 border-white/10">
            ...
            <CardFooter className="flex flex-col sm:flex-row sm:justify-between gap-3">
              <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                <Button variant="outline" className="border-white/10 hover:bg-white/5 w-full sm:w-auto" onClick={resetToDefaults}>
