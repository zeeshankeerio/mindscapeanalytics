      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="mt-16 text-center">
          <Button className="bg-red-600 hover:bg-red-700 text-white" asChild>
            <a href="mailto:zeeshan.keerio@mindscapeanalytics.com?subject=Partnership Inquiry">
              Become a Partner
          ...
          <p className="mt-4 text-white/60 text-sm">
            ...
            <a href="mailto:zeeshan.keerio@mindscapeanalytics.com?subject=Partnership Inquiry" className="text-red-500 hover:underline">
