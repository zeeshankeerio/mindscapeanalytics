  ...
  return (
    <div className="relative pt-28 pb-[10px] md:pb-20 overflow-hidden min-h-[calc(100vh-30px)] md:min-h-screen flex flex-col justify-start w-full">
      ...
      <FlexibleSection
        ...
        noPadding={false}
      >
        <div className="flex flex-col lg:flex-row items-center gap-5 md:gap-8 w-full px-0 md:px-5" style={{ transformOrigin: 'center center' }}>
          {/* Left Column - Content */}
          <motion.div
...
// Main CSS styles including zoom fixes
const styles = `
  ...
  /* Fix for zoom issues - minimal approach to avoid conflicts */
  .fixed-zoom {
      transform: scale(1);
