  ...
  const handleSendMessage = async () => {
    ...
    setTimeout(() => {
      const responses = [
        ...
        "That's an interesting question about our AI solutions. Our platform offers computer vision, NLP, and predictive analytics capabilities.",
        "Based on your requirements, I'd recommend our Enterprise plan which includes custom AI model development.",
        "You can find more information about that in our documentation at docs.mindscape.ai.",
        "Would you like me to connect you with one of our AI specialists to discuss your specific needs?",
        "Our computer vision models can achieve up to 99% accuracy for object detection tasks.",
        "The implementation timeline typically ranges from 2-8 weeks depending on the complexity of your requirements.",
      ]
